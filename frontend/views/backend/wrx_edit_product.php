...
<div class="form-horizontal">
	...
	<div id="fileupload" class="form-horizontal form-bordered">
		<div class="form-group">
			...
			<div class="col-md-9">
				<input id="p_name" class="form-control" value="" placeholder="" type="text"></div>
		</div>
		<div class="form-group">
...
{% } %}
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<div class="fileinput fileinput-new" data-provides="fileinput">
					<div class="fileinput-new thumbnail" data="img_0" style="width: 180px; height: 30px; display:none;">
						<img id="img_0" src="" alt="" >
						<input type="hidden" id="p_main_bg"></div>
					<br>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<input id="p_introduction" class="form-control" value="" placeholder="" type="text"></div>
		</div>
		<div class="form-group">
			<label class="col-md-2 control-label" for="title">详细信息</label>
			<div class="col-md-9">
				<textarea id="p_details" name="p_details" style="width:100%;height:200px;visibility:hidden;">请输入产品详细介绍</textarea>
			</div>
		</div>
		<div class="form-group">
							...
							<div class="tab-pane fontawesome-demo active" id="tab_1_1">
								...
								<div class="form-horizontal">
									<div class="form-group">
										...
										<div class="col-md-9">
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="fileinput-new thumbnail" data="img_a" style="width: 100px; height: 100px; display:none;">
													<img id="img_a" src="" alt="">
													<input id="weixin_sub_img_a" type="hidden"></div>
												<br>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input id="p_price" class="form-control" value="" placeholder="" type="text"></div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label" for="title">当前优惠说明</label>
										<div class="col-md-9">
											<textarea id="p_off_details" class="form-control" value="" placeholder="" type="text"></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label" for="title">优惠价格</label>
										<div class="col-md-9">
											<input id="p_off_price" class="form-control" value="" placeholder="" type="text"></div>
									</div>
									<div class="form-group">
								...
								<div class="portlet box blue weixin-subdes" style="display:;" data="1">
									<div class="portlet-title">
										<div class="caption">
									...
									<div class="portlet-body form">
										...
										<div class="form-body">
											<div class="form-group">
												...
												<div class="col-md-6">
													<div class="input-icon">
														...
														<input class="form-control weixin-sub-name" id="weixin_sub_name_1" placeholder="请输入消息标题" value="新介绍段落" type="text"></div>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-3">展示背景图</label>
												<div class="col-md-9">
													<div class="fileinput fileinput-new" data-provides="fileinput">
														<div class="fileinput-new thumbnail" data="img_1" style="width: 180px; height: 120px; display:none;">
															<img id="img_1" src="" alt="">
															<input id="weixin_sub_img_1" class="weixin-sub-img" type="hidden"></div>
														<br>
											...
											<div class="form-group last">
												<label class="control-label col-md-3">介绍段落</label>
												<div class="col-md-9">
													<textarea id="weixin_sub_des_1" class="weixin-sub-des"  name="weixin_sub_des_1" style="width:100%;height:200px;visibility:hidden;">请输入产品详细介绍</textarea>
												</div>
											</div>
										</div>
										<!-- END FORM-->
	...
	assets->getUrlPath('support/item')?>" id="preview_url">
			<a id="product_preview" style="display:none;" target="_blank" class="btn green btn-lg">预览</a>
		</div>
